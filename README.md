...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,248 | 🐛 2,162 | 🌐 Python | 📅 2026-09-14 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
...
* [Vowpal Wabbit](https://github.com/VowpalWabbit/vowpal_wabbit/wiki/Latent-Dirichlet-Allocation) ⭐ 8,717 | 🐛 1 | 🌐 C++ | 📅 2026-09-14 - C++ implementaion using online variational Bayes inference [:page\_facing\_up:](https://proceedings.neurips.cc/paper/2010/file/71f6278d140af599e06ad9bf1ba03cb0-Paper.pdf)
...
* [LDA\*](https://github.com/Angel-ML/angel/blob/master/docs/algo/lda_on_angel_en.md) ⭐ 6,791 | 🐛 139 | 🌐 Java | 📅 2026-09-11 - Tencent's hybrid sampler that uses different samplers for different types of documents in combination with an asymmetric parameter server [:page\_facing\_up:](http://www.vldb.org/pvldb/vol10/p1406-yu.pdf)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,835 | 🐛 472 | 🌐 Python | 📅 2026-09-09 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
* [Top2Vec](https://github.com/ddangelov/Top2Vec) ⭐ 3,107 | 🐛 84 | 🌐 Python | 📅 2024-11-14 - Python implementation that learns jointly embedded topic, document and word vectors [:page\_facing\_up:](https://arxiv.org/pdf/2008.09470.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,751 | 🐛 496 | 🌐 Python | 📅 2026-09-13 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
* [pyro](https://github.com/pyro-ppl/pyro) ⭐ 9,056 | 🐛 290 | 🌐 Python | 📅 2026-09-07 - PPL built on PyTorch, e.g., [prodLDA](http://pyro.ai/examples/prodlda.html) [:page\_facing\_up:](https://www.jmlr.org/papers/volume20/18-403/18-403.pdf)
...
* [TFP](https://github.com/tensorflow/probability) ⭐ 4,432 | 🐛 728 | 🌐 Jupyter Notebook | 📅 2026-09-09 - Probabilistic reasoning and statistical analysis in TensorFlow, e.g., [LDA](https://github.com/tensorflow/probability/blob/master/tensorflow_probability/examples/latent_dirichlet_allocation_distributions.py) ⭐ 4,432 | 🐛 728 | 🌐 Jupyter Notebook | 📅 2026-09-09 [:page\_facing\_up:](https://arxiv.org/pdf/2001.11819.pdf)
* [Stan](https://github.com/stan-dev/stan) ⭐ 2,769 | 🐛 153 | 🌐 C++ | 📅 2026-09-14 - Platform for statistical modeling and high-performance statistical computation, e.g., [LDA](https://mc-stan.org/docs/2_26/stan-users-guide/latent-dirichlet-allocation.html) [:page\_facing\_up:](https://files.eric.ed.gov/fulltext/ED590311.pdf)
...
* [awesome-datascience](https://github.com/academic/awesome-datascience) ⭐ 29,983 | 🐛 5 | 📅 2026-09-09
