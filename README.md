...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,235 | 🐛 2,162 | 🌐 Python | 📅 2026-09-12 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
* [gensim](https://github.com/RaRe-Technologies/gensim) ⭐ 16,483 | 🐛 440 | 🌐 Python | 📅 2025-11-01 - Python library for topic modelling ![GitHub Repo stars](https://img.shields.io/github/stars/RaRe-Technologies/gensim?style=social)
...
* [Vowpal Wabbit](https://github.com/VowpalWabbit/vowpal_wabbit/wiki/Latent-Dirichlet-Allocation) ⭐ 8,719 | 🐛 3 | 🌐 C++ | 📅 2026-09-13 - C++ implementaion using online variational Bayes inference [:page\_facing\_up:](https://proceedings.neurips.cc/paper/2010/file/71f6278d140af599e06ad9bf1ba03cb0-Paper.pdf)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,832 | 🐛 472 | 🌐 Python | 📅 2026-09-09 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,749 | 🐛 496 | 🌐 Python | 📅 2026-09-13 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
* [pyro](https://github.com/pyro-ppl/pyro) ⭐ 9,055 | 🐛 290 | 🌐 Python | 📅 2026-09-07 - PPL built on PyTorch, e.g., [prodLDA](http://pyro.ai/examples/prodlda.html) [:page\_facing\_up:](https://www.jmlr.org/papers/volume20/18-403/18-403.pdf)
...
* [Turing.jl](https://github.com/TuringLang/Turing.jl) ⭐ 2,254 | 🐛 14 | 🌐 Julia | 📅 2026-09-13 -  Julia library for general-purpose probabilistic programming [:page\_facing\_up:](http://proceedings.mlr.press/v84/ge18b/ge18b.pdf)
...
* [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,321 | 🐛 29 | 🌐 Python | 📅 2026-09-12
* [awesome-datascience](https://github.com/academic/awesome-datascience) ⭐ 29,970 | 🐛 5 | 📅 2026-09-09
