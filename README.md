...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,343 | 🐛 2,152 | 🌐 Python | 📅 2026-09-22 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,849 | 🐛 474 | 🌐 Python | 📅 2026-09-22 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,766 | 🐛 509 | 🌐 Python | 📅 2026-09-21 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
...
* [awesome-datascience](https://github.com/academic/awesome-datascience) ⭐ 30,052 | 🐛 6 | 📅 2026-09-21
