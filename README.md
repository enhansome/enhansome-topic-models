...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 66,968 | 🐛 2,122 | 🌐 Python | 📅 2026-08-13 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
* [gensim](https://github.com/RaRe-Technologies/gensim) ⭐ 16,481 | 🐛 436 | 🌐 Python | 📅 2025-11-01 - Python library for topic modelling ![GitHub Repo stars](https://img.shields.io/github/stars/RaRe-Technologies/gensim?style=social)
...
* [Vowpal Wabbit](https://github.com/VowpalWabbit/vowpal_wabbit/wiki/Latent-Dirichlet-Allocation) ⭐ 8,700 | 🐛 3 | 🌐 C++ | 📅 2026-07-15 - C++ implementaion using online variational Bayes inference [:page\_facing\_up:](https://proceedings.neurips.cc/paper/2010/file/71f6278d140af599e06ad9bf1ba03cb0-Paper.pdf)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,784 | 🐛 467 | 🌐 Python | 📅 2026-08-02 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,705 | 🐛 476 | 🌐 Python | 📅 2026-08-13 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
* [pyro](https://github.com/pyro-ppl/pyro) ⭐ 9,037 | 🐛 283 | 🌐 Python | 📅 2026-08-04 - PPL built on PyTorch, e.g., [prodLDA](http://pyro.ai/examples/prodlda.html) [:page\_facing\_up:](https://www.jmlr.org/papers/volume20/18-403/18-403.pdf)
...
* [Stan](https://github.com/stan-dev/stan) ⭐ 2,760 | 🐛 152 | 🌐 C++ | 📅 2026-08-12 - Platform for statistical modeling and high-performance statistical computation, e.g., [LDA](https://mc-stan.org/docs/2_26/stan-users-guide/latent-dirichlet-allocation.html) [:page\_facing\_up:](https://files.eric.ed.gov/fulltext/ED590311.pdf)
...
* [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,015 | 🐛 25 | 🌐 Python | 📅 2026-08-11
* [awesome-datascience](https://github.com/academic/awesome-datascience) ⭐ 29,808 | 🐛 8 | 📅 2026-08-10
