...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,380 | 🐛 2,154 | 🌐 Python | 📅 2026-09-24 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
...
* [Vowpal Wabbit](https://github.com/VowpalWabbit/vowpal_wabbit/wiki/Latent-Dirichlet-Allocation) ⭐ 8,721 | 🐛 2 | 🌐 C++ | 📅 2026-09-25 - C++ implementaion using online variational Bayes inference [:page\_facing\_up:](https://proceedings.neurips.cc/paper/2010/file/71f6278d140af599e06ad9bf1ba03cb0-Paper.pdf)
* [lda](https://github.com/lda-project/lda) ⭐ 1,313 | 🐛 0 | 🌐 Python | 📅 2024-07-29 - Python implementation using collapsed Gibbs sampling which follows scikit-learn interface [:page\_facing\_up:](https://www.pnas.org/content/pnas/101/suppl_1/5228.full.pdf)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,856 | 🐛 473 | 🌐 Python | 📅 2026-09-24 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
* [Top2Vec](https://github.com/ddangelov/Top2Vec) ⭐ 3,109 | 🐛 84 | 🌐 Python | 📅 2024-11-14 - Python implementation that learns jointly embedded topic, document and word vectors [:page\_facing\_up:](https://arxiv.org/pdf/2008.09470.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,776 | 🐛 516 | 🌐 Python | 📅 2026-09-21 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
...
* [Stan](https://github.com/stan-dev/stan) ⭐ 2,772 | 🐛 155 | 🌐 C++ | 📅 2026-09-25 - Platform for statistical modeling and high-performance statistical computation, e.g., [LDA](https://mc-stan.org/docs/2_26/stan-users-guide/latent-dirichlet-allocation.html) [:page\_facing\_up:](https://files.eric.ed.gov/fulltext/ED590311.pdf)
...
* [awesome-datascience](https://github.com/academic/awesome-datascience) ⭐ 30,065 | 🐛 6 | 📅 2026-09-24
