...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,223 | 🐛 2,149 | 🌐 Python | 📅 2026-09-10 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
* [gensim](https://github.com/RaRe-Technologies/gensim) ⭐ 16,482 | 🐛 439 | 🌐 Python | 📅 2025-11-01 - Python library for topic modelling ![GitHub Repo stars](https://img.shields.io/github/stars/RaRe-Technologies/gensim?style=social)
...
* [Vowpal Wabbit](https://github.com/VowpalWabbit/vowpal_wabbit/wiki/Latent-Dirichlet-Allocation) ⭐ 8,716 | 🐛 2 | 🌐 C++ | 📅 2026-08-26 - C++ implementaion using online variational Bayes inference [:page\_facing\_up:](https://proceedings.neurips.cc/paper/2010/file/71f6278d140af599e06ad9bf1ba03cb0-Paper.pdf)
...
* [MeTA](https://github.com/meta-toolkit/meta) ⭐ 717 | 🐛 56 | 🌐 C++ | 📅 2023-04-17 - C++ implementation of (parallel) collapsed [Gibbs sampling, CVB0 and SCVB](https://meta-toolkit.org/topic-models-tutorial.html)
...
* [LDA\*](https://github.com/Angel-ML/angel/blob/master/docs/algo/lda_on_angel_en.md) ⭐ 6,788 | 🐛 139 | 🌐 Java | 📅 2026-09-09 - Tencent's hybrid sampler that uses different samplers for different types of documents in combination with an asymmetric parameter server [:page\_facing\_up:](http://www.vldb.org/pvldb/vol10/p1406-yu.pdf)
* [Familia](https://github.com/baidu/Familia) ⭐ 2,643 | 🐛 28 | 🌐 C++ | 📅 2021-07-01 - A toolkit for industrial topic modeling (LDA, SentenceLDA and Topical Word Embedding) [:warning:](https://github.com/baidu/Familia/issues/111) ⭐ 2,643 | 🐛 28 | 🌐 C++ | 📅 2021-07-01 [:page\_facing\_up:](https://arxiv.org/pdf/1707.09823.pdf)
...
* [Familia](https://github.com/baidu/Familia) ⭐ 2,643 | 🐛 28 | 🌐 C++ | 📅 2021-07-01 - Apply inference on pre-trained SentenceLDA models [:warning:](https://github.com/baidu/Familia/issues/111) ⭐ 2,643 | 🐛 28 | 🌐 C++ | 📅 2021-07-01 [:page\_facing\_up:](https://arxiv.org/pdf/1707.09823.pdf)
...
* [shorttext](https://github.com/stephenhky/PyShortTextCategorization) ⭐ 472 | 🐛 0 | 🌐 Python | 📅 2026-09-09 -  Python implementation of various algorithms for Short Text Mining
...
* [MLTM](https://github.com/hsoleimani/MLTM) ⭐ 27 | 🐛 0 | 🌐 Python | 📅 2017-04-02 - C implementation of multilabel topic model (MLTM) [:page\_facing\_up:](https://www.mitpressjournals.org/doi/pdf/10.1162/NECO_a_00939)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,831 | 🐛 471 | 🌐 Python | 📅 2026-09-09 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
* [Top2Vec](https://github.com/ddangelov/Top2Vec) ⭐ 3,106 | 🐛 84 | 🌐 Python | 📅 2024-11-14 - Python implementation that learns jointly embedded topic, document and word vectors [:page\_facing\_up:](https://arxiv.org/pdf/2008.09470.pdf)
* [CTM](https://github.com/MilaNLProc/contextualized-topic-models) ⭐ 1,271 | 🐛 11 | 🌐 Python | 📅 2025-07-24 - CTMs combine contextualized embeddings (e.g., BERT) with topic models
...
* [G-LDA](https://github.com/rajarshd/Gaussian_LDA) ⭐ 142 | 🐛 1 | 🌐 HTML | 📅 2019-12-31 - Java implementation of Gaussian LDA using word embeddings [:page\_facing\_up:](https://www.aclweb.org/anthology/P15-1077.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,744 | 🐛 494 | 🌐 Python | 📅 2026-09-09 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
* [pyro](https://github.com/pyro-ppl/pyro) ⭐ 9,050 | 🐛 288 | 🌐 Python | 📅 2026-09-07 - PPL built on PyTorch, e.g., [prodLDA](http://pyro.ai/examples/prodlda.html) [:page\_facing\_up:](https://www.jmlr.org/papers/volume20/18-403/18-403.pdf)
...
* [TFP](https://github.com/tensorflow/probability) ⭐ 4,433 | 🐛 728 | 🌐 Jupyter Notebook | 📅 2026-09-09 - Probabilistic reasoning and statistical analysis in TensorFlow, e.g., [LDA](https://github.com/tensorflow/probability/blob/master/tensorflow_probability/examples/latent_dirichlet_allocation_distributions.py) ⭐ 4,433 | 🐛 728 | 🌐 Jupyter Notebook | 📅 2026-09-09 [:page\_facing\_up:](https://arxiv.org/pdf/2001.11819.pdf)
* [Stan](https://github.com/stan-dev/stan) ⭐ 2,768 | 🐛 152 | 🌐 C++ | 📅 2026-09-10 - Platform for statistical modeling and high-performance statistical computation, e.g., [LDA](https://mc-stan.org/docs/2_26/stan-users-guide/latent-dirichlet-allocation.html) [:page\_facing\_up:](https://files.eric.ed.gov/fulltext/ED590311.pdf)
* [Turing.jl](https://github.com/TuringLang/Turing.jl) ⭐ 2,254 | 🐛 14 | 🌐 Julia | 📅 2026-09-07 -  Julia library for general-purpose probabilistic programming [:page\_facing\_up:](http://proceedings.mlr.press/v84/ge18b/ge18b.pdf)
* [ZhuSuan](https://github.com/thu-ml/zhusuan) ⭐ 2,217 | 🐛 13 | 🌐 Python | 📅 2022-12-17 - A PPL for Bayesian deep learning, generative models, built on Tensorflow, e.g., [LDA](https://zhusuan.readthedocs.io/en/latest/tutorials/lntm.html) [:page\_facing\_up:](https://arxiv.org/pdf/1709.05870.pdf)
...
* [dtm](https://github.com/blei-lab/dtm) ⭐ 206 | 🐛 8 | 🌐 Shell | 📅 2017-12-12 - C implementation of dynamic topic models by David Blei & Sean Gerrish
...
* [LDAvis](https://github.com/cpsievert/LDAvis) ⭐ 571 | 🐛 35 | 🌐 JavaScript | 📅 2024-02-06 - R package for interactive topic model visualization
...
* [stminsights](https://github.com/cschwem2er/stminsights) ⭐ 121 | 🐛 2 | 🌐 R | 📅 2026-09-02 - A Shiny Application for Inspecting Structural Topic Models
...
* [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,292 | 🐛 34 | 🌐 Python | 📅 2026-09-08
* [awesome-datascience](https://github.com/academic/awesome-datascience) ⭐ 29,959 | 🐛 4 | 📅 2026-09-09
* [awesome-python-data-science](https://github.com/krzjoa/awesome-python-data-science) ⭐ 3,585 | 🐛 21 | 📅 2026-04-13
