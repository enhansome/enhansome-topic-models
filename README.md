...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,072 | 🐛 2,126 | 🌐 Python | 📅 2026-08-26 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
...
* [shorttext](https://github.com/stephenhky/PyShortTextCategorization) ⭐ 472 | 🐛 0 | 🌐 Python | 📅 2026-08-26 -  Python implementation of various algorithms for Short Text Mining
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,805 | 🐛 469 | 🌐 Python | 📅 2026-08-22 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,723 | 🐛 487 | 🌐 Python | 📅 2026-08-24 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
* [pyro](https://github.com/pyro-ppl/pyro) ⭐ 9,042 | 🐛 285 | 🌐 Python | 📅 2026-08-27 - PPL built on PyTorch, e.g., [prodLDA](http://pyro.ai/examples/prodlda.html) [:page\_facing\_up:](https://www.jmlr.org/papers/volume20/18-403/18-403.pdf)
...
* [TFP](https://github.com/tensorflow/probability) ⭐ 4,428 | 🐛 726 | 🌐 Jupyter Notebook | 📅 2026-08-06 - Probabilistic reasoning and statistical analysis in TensorFlow, e.g., [LDA](https://github.com/tensorflow/probability/blob/master/tensorflow_probability/examples/latent_dirichlet_allocation_distributions.py) ⭐ 4,428 | 🐛 726 | 🌐 Jupyter Notebook | 📅 2026-08-06 [:page\_facing\_up:](https://arxiv.org/pdf/2001.11819.pdf)
* [Stan](https://github.com/stan-dev/stan) ⭐ 2,761 | 🐛 154 | 🌐 C++ | 📅 2026-08-26 - Platform for statistical modeling and high-performance statistical computation, e.g., [LDA](https://mc-stan.org/docs/2_26/stan-users-guide/latent-dirichlet-allocation.html) [:page\_facing\_up:](https://files.eric.ed.gov/fulltext/ED590311.pdf)
* [Turing.jl](https://github.com/TuringLang/Turing.jl) ⭐ 2,251 | 🐛 29 | 🌐 Julia | 📅 2026-08-27 -  Julia library for general-purpose probabilistic programming [:page\_facing\_up:](http://proceedings.mlr.press/v84/ge18b/ge18b.pdf)
