...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,163 | 🐛 2,146 | 🌐 Python | 📅 2026-09-04 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,818 | 🐛 468 | 🌐 Python | 📅 2026-09-03 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
...
* [pyro](https://github.com/pyro-ppl/pyro) ⭐ 9,044 | 🐛 287 | 🌐 Python | 📅 2026-09-04 - PPL built on PyTorch, e.g., [prodLDA](http://pyro.ai/examples/prodlda.html) [:page\_facing\_up:](https://www.jmlr.org/papers/volume20/18-403/18-403.pdf)
...
* [Turing.jl](https://github.com/TuringLang/Turing.jl) ⭐ 2,254 | 🐛 13 | 🌐 Julia | 📅 2026-09-04 -  Julia library for general-purpose probabilistic programming [:page\_facing\_up:](http://proceedings.mlr.press/v84/ge18b/ge18b.pdf)
