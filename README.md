...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,102 | 🐛 2,135 | 🌐 Python | 📅 2026-08-28 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
...
* [MeTA](https://github.com/meta-toolkit/meta) ⭐ 716 | 🐛 56 | 🌐 C++ | 📅 2023-04-17 - C++ implementation of (parallel) collapsed [Gibbs sampling, CVB0 and SCVB](https://meta-toolkit.org/topic-models-tutorial.html)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,809 | 🐛 469 | 🌐 Python | 📅 2026-08-28 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,732 | 🐛 489 | 🌐 Python | 📅 2026-08-24 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
...
* [Stan](https://github.com/stan-dev/stan) ⭐ 2,764 | 🐛 154 | 🌐 C++ | 📅 2026-08-29 - Platform for statistical modeling and high-performance statistical computation, e.g., [LDA](https://mc-stan.org/docs/2_26/stan-users-guide/latent-dirichlet-allocation.html) [:page\_facing\_up:](https://files.eric.ed.gov/fulltext/ED590311.pdf)
* [Turing.jl](https://github.com/TuringLang/Turing.jl) ⭐ 2,252 | 🐛 22 | 🌐 Julia | 📅 2026-08-30 -  Julia library for general-purpose probabilistic programming [:page\_facing\_up:](http://proceedings.mlr.press/v84/ge18b/ge18b.pdf)
...
* [awesome-datascience](https://github.com/academic/awesome-datascience) ⭐ 29,897 | 🐛 8 | 📅 2026-08-27
