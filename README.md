...
* [scikit-learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,159 | 🐛 2,143 | 🌐 Python | 📅 2026-09-04 - Python library for machine learning ![GitHub Repo stars](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=social)
...
* [BERTopic](https://github.com/MaartenGr/BERTopic) ⭐ 7,817 | 🐛 468 | 🌐 Python | 📅 2026-09-03 - BERTopic supports guided, (semi-) supervised, and dynamic topic modeling and visualization [:page\_facing\_up:](https://arxiv.org/pdf/2203.05794.pdf)
* [Top2Vec](https://github.com/ddangelov/Top2Vec) ⭐ 3,104 | 🐛 84 | 🌐 Python | 📅 2024-11-14 - Python implementation that learns jointly embedded topic, document and word vectors [:page\_facing\_up:](https://arxiv.org/pdf/2008.09470.pdf)
...
* [PyMC3](https://github.com/pymc-devs/pymc3) ⭐ 9,737 | 🐛 490 | 🌐 Python | 📅 2026-09-03 - Python package for Bayesian statistical modeling and probabilistic machine learning, e.g., [LDA](http://docs.pymc.io/notebooks/lda-advi-aevb.html) [:page\_facing\_up:](https://peerj.com/articles/cs-55.pdf)
...
* [Stan](https://github.com/stan-dev/stan) ⭐ 2,763 | 🐛 156 | 🌐 C++ | 📅 2026-09-03 - Platform for statistical modeling and high-performance statistical computation, e.g., [LDA](https://mc-stan.org/docs/2_26/stan-users-guide/latent-dirichlet-allocation.html) [:page\_facing\_up:](https://files.eric.ed.gov/fulltext/ED590311.pdf)
* [Turing.jl](https://github.com/TuringLang/Turing.jl) ⭐ 2,254 | 🐛 15 | 🌐 Julia | 📅 2026-09-04 -  Julia library for general-purpose probabilistic programming [:page\_facing\_up:](http://proceedings.mlr.press/v84/ge18b/ge18b.pdf)
...
* [awesome-datascience](https://github.com/academic/awesome-datascience) ⭐ 29,933 | 🐛 12 | 📅 2026-09-02
